...
При отправке событий ответ ждать не нужно, исключение составляет лишь пакетная загрузка событий, детали которой описаны в [соответствующем разделе](http-tracking-api.md#specifika-ispolzovaniya-paketnoi-zagruzki).
