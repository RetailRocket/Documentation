...
Для полноценной работы Retail Rocket требуется передать в систему товарную базу магазина. Товарная база формируется два основных набора данных: сведения о товарах и дерево категорий товарной базы.
