...
Для полноценной эффективной работы Retail Rocket требуется передать в систему товарную базу магазина. Товарная база формируется два основных набора данных: сведения о товарах и дерево категорий товарной базы.

Эти данные повышают качество рекомендаций и используются для фильтрации товарной выдачи от товаров вышедших из наличия.
