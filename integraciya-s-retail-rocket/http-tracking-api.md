...
Для того чтобы пользовательское поведение было правильнно учтенно в системе контактов, в момент когда становится известен идентификатор посетителя\(логин на сайте\) необходимо передать устойчивый идентификатор посетителя в систему Retail Rocket.
