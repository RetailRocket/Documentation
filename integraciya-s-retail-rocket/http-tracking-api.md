...
В теле запроса передается объект типа **`addToBasket`** со следующими полями:
...
В теле запроса передается объект типа **`categoryView`** со следующими полями:
...
В теле запроса передается объект типа **`order`** со следующими полями:
...
В теле запроса передается объект типа **`search`** со следующими полями:
