...
Пользовательское поведение необходимо для многих продуктов Retail Rocket: товарные рекомендации, автоматизированые коммуникационные кампании, метрики эфективности коммуникаций и т.д.
...
| Имя поля | Обязательное | Тип | Описание |
| :--- | :--- | :--- | :--- |
| `impressionContentViewed` | Да | `ImpressionContentViewedEvent` | Тип&nbps;подробно&nbps;описан в разделе "Просмотр спонсорского контента" как тип параметра тела запроса |
